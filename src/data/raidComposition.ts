...
export const RAID_COMPOSITION_DATA_METADATA = {
  version: 'kr-2026-09-04-review-1',
  ...
  sources: [
    ...
    },
    {
      ...
      label: '공식 알려진 이슈 — 디스트로이어·차원술사 갑옷 파괴 중첩',
      url: 'https://lostark.game.onstove.com/News/Notice/Views/13482',
    },
    {
...
export const RAID_CLASS_DATA: readonly RaidClassData[] = [
  { name: '디스트로이어', role: 'dealer', position: 'entropy-head', synergies: synergy('방어력 감소', 'destroyer'), sourceIds: COMMUNITY_SOURCE, needsReview: true },
  ...
  { name: '워로드', role: 'dealer', position: 'entropy-head', synergies: synergy('헤드·백어택 피해 증가', 'gunlancer'), sourceIds: COMMUNITY_SOURCE, needsReview: true },
  { name: '홀리나이트', role: 'support', position: 'unknown', synergies: [], sourceIds: COMMUNITY_SOURCE, needsReview: true, reviewReason: '딜러 각인 사용 여부 수동 확인 필요' },
  ...
  { name: '인파이터', role: 'dealer', position: 'entropy-back', synergies: synergy('피해 증가', 'scrapper'), sourceIds: COMMUNITY_SOURCE, needsReview: true },
  ...
  { name: '창술사', role: 'dealer', position: 'unknown', synergies: synergy('치명타 피해 증가', 'glaivier'), sourceIds: COMMUNITY_SOURCE, needsReview: true, reviewReason: '빌드에 따른 공격 포지션 수동 확인 필요' },
  { name: '기공사', role: 'dealer', position: 'hit-master', synergies: synergy('공격력 증가', 'soulfist'), sourceIds: COMMUNITY_SOURCE, needsReview: true },
  { name: '브레이커', role: 'dealer', position: 'entropy-head', synergies: synergy('피해 증가', 'breaker'), sourceIds: COMMUNITY_SOURCE, needsReview: true },
  ...
  { name: '블래스터', role: 'dealer', position: 'hit-master', synergies: synergy('방어력 감소', 'artillerist'), sourceIds: COMMUNITY_SOURCE, needsReview: true },
  ...
  { name: '바드', role: 'support', position: 'unknown', synergies: [], sourceIds: COMMUNITY_SOURCE, needsReview: false },
  ...
  { name: '도화가', role: 'support', position: 'unknown', synergies: [], sourceIds: COMMUNITY_SOURCE, needsReview: false },
  ...
  { name: '차원술사', role: 'dealer', position: 'unknown', synergies: synergy('방어력 감소', 'dimensionmaster'), sourceIds: OFFICIAL_DIMENSIONMASTER_SOURCE, needsReview: true, reviewReason: '공식 자료에서 공격 포지션을 확인하지 못함' },
