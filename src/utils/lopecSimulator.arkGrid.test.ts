...
describe('calcLopecDelta Ark Grid combat power changes', () => {
  it('applies measured ancient order moon 18P to 20P delta', () => {
    ...
    expect(scoreWithArkGrid(4933.35, current, modified)).toBeCloseTo(4948.331186159934, 6);
  });
  ...
  it('applies measured ancient order moon 18P to relic order moon 18P delta', () => {
    ...
    expect(scoreWithArkGrid(4933.35, current, modified)).toBeCloseTo(4887.95246618202, 6);
  });
  ...
  it('applies measured dealer Ark Grid gem option levels', () => {
    ...
    expect(scoreWithArkGrid(4933.35, current, modified)).toBeCloseTo(4934.81, 2);
  });
  ...
  it('keeps unsupported chaos star weapon core neutral', () => {
    ...
    expect(scoreWithArkGrid(4933.35, current, modified)).toBeCloseTo(4933.35, 6);
  });
});
